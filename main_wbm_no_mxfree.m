...
z_id = 3;
savename = 'vbplate_5x5_wbm_p90';

%% Load single UC model (identical UCs)
disp('Loading UC model ...')
load([filename,'.mat']);
% F_UC_FOM = comsol_matrices.forc;
[K_UC_FOM, M_UC_FOM, C_UC_FOM, UC_nodes, UC_coordinates, L_UC_x, L_UC_y] = import_FE_UC2(filename, import_option);
...
%% WBM frequency loop
parfor iWave = 1:numel(omega_range)
    iWave
